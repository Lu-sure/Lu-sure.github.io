const contentArray = [
  {
    ...
    img: "img/sheldon.jpg",
    known:
      "Smelly Pooper, Shelly Bean, Sheldor, Dr. Dumbass and C3P-Wee Herman.",
    appearance: "T-shirts over a long-sleeve shirt.",
    quotes: '"Bazinga!"',
    fondOf:
      "science fiction, comic books, costumes, video games, flags, trains.",
    features:
      "an eidetic memory, obsessive–compulsive disorder, speaking Klingon.",
  },
  {
    ...
    appearance:
      "weird eyebrows, sweat shirt with hood worn under a jacket, and Converse All Stars sneakers",
    quotes:
      '"People get things they don`t deserve all the time. Like me with you."',
    fondOf:
      "science fiction, comic books, fan costumes, video games, Penny, lazers.",
    features:
      "an extremely bad vision, lactose intolerance, asthma, playing the cello, speaking Klingon.",
  },
  {
    ...
    appearance:
      "chocolate skin, a layered combination of a shirt, a sweater vest, and a windbreaker with skate shoes.",
    quotes: "\"I've said this before and I'll say it again: Aquaman sucks!\"",
    fondOf:
      "science fiction, comic books, fan costumes, video games, his dog Cinnamon.",
    features:
      "an Indian English accent, selective mutism social anxiety disorder, metrosexuality.",
  },
  {
    ...
    appearance:
      "a bowl haircut, loud, vintage, 1960-era outfit, a shirt over a turtleneck or dickey on the neck, Vans or Converse sneakers, and skinny pants with massive belt buckle.",
    quotes: '"I\'m a horny engineer... I never joke about math or sex."',
    fondOf:
      "science fiction, comic books, fan costumes, video games, magic and card tricks.",
...
const renderSide = function () {
  ...
  let renderedHero = ul.firstChild;
  renderedHero.classList.add("active-hero");
  ul.addEventListener("click", ({ target }) => {
    if (target == ul || renderedHero == target) {
      return;
    }
    changeContent(target.getAttribute("data-idx"));
    target.classList.add("active-hero");
    renderedHero.classList.remove("active-hero");
...
const render = function (index) {
  ...
  contentWrapper.classList.add("hero-wrapper");
};
